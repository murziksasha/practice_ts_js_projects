...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_modal_modal__WEBPACK_IMPORTED_MODULE_1__["modal"])('div.popup', 'a.phone_link');
  Object(_modules_modal_modal__WEBPACK_IMPORTED_MODULE_1__["modal"])('div.popup', '.feedback_block.text-center a.phone_link');
  Object(_modules_tabs_tabs__WEBPACK_IMPORTED_MODULE_2__["tabs"])('.glazing_slider', '.glazing_block', '.glazing_content', 'active');
  Object(_modules_tabs_tabs__WEBPACK_IMPORTED_MODULE_2__["tabs"])('.decoration_slider', '.no_click', '.decoration_content > div > div', 'after_click');
  Object(_modules_forms_forms__WEBPACK_IMPORTED_MODULE_3__["forms"])('status'); // calculator();
});
...
function modal(modalSelector, btnSelector) {
  ...
  var modalPop = document.querySelector(modalSelector);
  var btnModal = document.querySelector(btnSelector);
  var modalTimerId;
