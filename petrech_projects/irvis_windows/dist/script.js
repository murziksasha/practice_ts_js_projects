...
/* harmony import */ var _modules_tabs_tabs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/tabs/tabs */ "./src/js/modules/tabs/tabs.js");
...
window.addEventListener('DOMContentLoaded', function () {
  var deadline = '20-05-2023';
  var modalState = {};
  Object(_modules_changeModalState_changeModalState__WEBPACK_IMPORTED_MODULE_4__["changeModalState"])(modalState);
  Object(_modules_modal_modal__WEBPACK_IMPORTED_MODULE_1__["modal"])('div.popup_engineer', 'button.header_btn.text-uppercase.text-left.popup_engineer_btn');
  Object(_modules_modal_modal__WEBPACK_IMPORTED_MODULE_1__["modal"])('.popup', 'a.phone_link');
  Object(_modules_modal_modal__WEBPACK_IMPORTED_MODULE_1__["modal"])('.popup', '.feedback_block.text-center a.phone_link'); //модалки по расчету стоимости

  Object(_modules_modal_modal__WEBPACK_IMPORTED_MODULE_1__["modal"])('.popup_calc', '.popup_calc_btn', false, undefined, false);
  Object(_modules_modal_modal__WEBPACK_IMPORTED_MODULE_1__["modal"])('.popup_calc_profile', '.popup_calc_button', false, undefined, false);
  Object(_modules_modal_modal__WEBPACK_IMPORTED_MODULE_1__["modal"])('.popup_calc_end', '.popup_calc_profile_button', false, undefined, false);
  Object(_modules_tabs_tabs__WEBPACK_IMPORTED_MODULE_2__["tabs"])('.glazing_slider', '.glazing_block', '.glazing_content', 'active');
  Object(_modules_tabs_tabs__WEBPACK_IMPORTED_MODULE_2__["tabs"])('.decoration_slider', '.no_click', '.decoration_content > div > div', 'after_click'); //внутренние табы с калькулятором и расчетами
...
/***/ "./src/js/modules/changeModalState/changeModalState.js":
/*!*************************************************************!*\
  !*** ./src/js/modules/changeModalState/changeModalState.js ***!
  \*************************************************************/
...
/* harmony import */ var _checkNumInputs_checkNumInputs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../checkNumInputs/checkNumInputs */ "./src/js/modules/checkNumInputs/checkNumInputs.js");
...
function changeModalState(state) {
  ...
  Object(_checkNumInputs_checkNumInputs__WEBPACK_IMPORTED_MODULE_1__["checkNumInputs"])('#width');
  Object(_checkNumInputs_checkNumInputs__WEBPACK_IMPORTED_MODULE_1__["checkNumInputs"])('#height');
        ...
        switch (item.nodeName) {
          ...
          case 'INPUT':
            if (item.getAttribute('type') === 'checkbox') {
              ...
              item instanceof HTMLInputElement ? state[prop] = item.value : null;
            }

            break;

          case 'SELECT':
            item instanceof HTMLSelectElement ? state[prop] = item.value : null;
            break;
        }
...
/***/ "./src/js/modules/checkNumInputs/checkNumInputs.js":
/*!*********************************************************!*\
  !*** ./src/js/modules/checkNumInputs/checkNumInputs.js ***!
  \*********************************************************/
...
/* harmony import */ var _checkNumInputs_checkNumInputs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../checkNumInputs/checkNumInputs */ "./src/js/modules/checkNumInputs/checkNumInputs.js");
...
function forms(state, classModal, PhoneInputDataAtt) {
  var formsAll = document.querySelectorAll('form');
  Object(_checkNumInputs_checkNumInputs__WEBPACK_IMPORTED_MODULE_5__["checkNumInputs"])(PhoneInputDataAtt);
  var message = {
...
function modal(modalSelector, btnSelector) {
  ...
  var showClass = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'show';
  var closeClickOverlay = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : true;
  var modalsPop = document.querySelectorAll(modalSelector);
  ...
  modalsPop.forEach(function (item) {
  ...
  if (timer) {
    ...
    window.addEventListener('scroll', function () {
      return showModalByScroll(modalsPop[0]);
    });
...
function tabs(tabParent, tabItem, tabBody, activeClass) {
  var showClass = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'show';
  var tabParentItem = document.querySelector(tabParent);
  var tabsItem = document.querySelectorAll(tabItem);
  var tabContents = document.querySelectorAll(tabBody);
  ...
  function tabBodyShow() {
    var tabNum = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
