...
export function checkTextInputs(selector: string) {
...
export function checkMailInputs(selector: string) {
  const mailInputs = document.querySelectorAll<HTMLInputElement>(selector);
